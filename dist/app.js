...
const prep_ftyp_moov_1 = require("./prep_ftyp_moov");
...
const myVideoStreamerInstance = new video_streamer_class_1.default("rtsp://wenyen.lc4i.club:8554/meeting", 4001);
...
//     "-",
// ]);
const path = "./execution_time_log.txt";
let writeStream;
writeStream = fs_1.default.createWriteStream(path, { flags: 'a' });
ffmpeg.stdout.on("data", (chunk) => {
    ...
    if (myVideoStreamerInstance.processing_counter_queue.length > 0) {
        ...
        myVideoStreamerInstance
            ...
            .forEach((job_info) => {
            jobs_removal_counter = (0, prep_ftyp_moov_1.prep_ftyp_moov)(myVideoStreamerInstance, job_info, jobs_removal_counter, writeStream);
            jobs_removal_counter = (0, prep_moof_mdat_1.prep_moof_mdat)(myVideoStreamerInstance, job_info, jobs_removal_counter, writeStream);
